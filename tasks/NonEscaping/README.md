NonEscaping
===========
> Юный хакер Вася разрабатывает свой сервис для получения лицензионных ключей. Бета-версию нельзя найти в Google, но Вася поделился с нами прямой ссылкой: licensekey.qctf.ru
